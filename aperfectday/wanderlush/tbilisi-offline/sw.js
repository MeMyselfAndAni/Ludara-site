...
const TILE_CACHE = 'stadia-tiles-v1';
...
self.addEventListener('fetch', event => {
  ...
  if (url.hostname.endsWith('tile.openstreetmap.org') || url.hostname.endsWith('basemaps.cartocdn.com') || url.hostname.endsWith('stadiamaps.com') || url.hostname.endsWith('stadiamaps.com')) {
    event.respondWith(
