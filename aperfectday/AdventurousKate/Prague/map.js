...
function initMap() {
  ...
  map.on('error', function(e) {
    // Was: a permanent red developer overlay printing the raw error across the
    // reader's screen, for every error including ordinary transient tile
    // failures, with no way to dismiss it. Removed 8 September 2026.
    // The tile notice below explains a failed base map in plain language.
