  ...
  var STEPS = [
    {
      ...
      body: 'One map. The places The Drisco concierge would send you to, most guests never find. Old Jaffa workshops, a wine bar locals actually use, a kiosk for the best sunset on the coast. Tap Next to begin.',
      target: null,
      cardPos: 'center',
      demo: null,
      btn: 'Next'
    },
    {
      ...
      body: 'Every pin is a choice: a gallery in a Jaffa courtyard, a ceramicist who glazes each piece by hand, a seafront table for the freshest catch. Tap any icon to see why it made the list.',
      target: null,
      cardPos: 'center',
    ...
    },
    {
      ...
      body: 'Looking for a wine bar with real local bites? A design shop full of Israeli makers? Slide the bar to show only the category you want, the map follows.',
      target: '.filter-bar',
      cardPos: 'center',
      closeCard: true,
      demo: 'scroll-filter',
    ...
    },
    {
      ...
      body: 'Each button is a Tel Aviv or Jaffa neighbourhood. Tap to zoom straight in, from Old Jaffa and the flea market to Neve Tzedek and the sea.',
      target: '#nbhd-bar',
      cardPos: 'center',
      closeCard: true,
      demo: null,
    ...
    },
    {
      ...
      body: 'Jaffa\'s old lanes can swallow a signal. Tap the circle to find yourself on the map. Save it offline and it works without Wifi too.',
      target: null,
