...
const PLACES = [
  ...
  // ── NEW: CULTURAL LANDMARKS & NEIGHBOURHOODS (Ludara-curated) ──────────────
...

  {
    ...
    note: "Six hundred traditional hanok houses on a hillside between Gyeongbokgung and Changdeokgung — one of the few places in central Seoul where the city's pre-concrete streetscape survives intact. The neighbourhood is still residential. Bukchon Alley 11 (골목길 11) at the top of the hill gives the most photographed view in the city: a descending lane of tiled rooftops with the modern skyline behind. The Bukchon Traditional Culture Center on Gahoe-ro offers free weekday workshops in hanji papermaking, pottery, and embroidery.",
    hours: 'Outdoor neighbourhood — always accessible. Culture Center: Tue–Sun 09:00–18:00.',
    tip: 'Come before 09:00 or after 17:00. Residents have formally complained about noise — the alley signs asking for quiet are not decorative.',
...

  {
    ...
    note: "The most intact of Seoul's five royal palaces and the one UNESCO listed in 1997. Built in 1405 as a secondary palace, it became the primary royal residence after the Japanese burned Gyeongbokgung in 1592. The main complex is good; the Huwon (Secret Garden) at the rear is the reason to come — 78 acres of pavilions, lotus ponds, bamboo groves, and trees over 300 years old on a hillside where the royal family came to rest. The Huwon is accessible only by timed guided tour.",
    hours: 'Tue–Sun 09:00–17:30 (winter) / 09:00–18:30 (summer); closed Mon. Moonlight tours select dates Apr–Oct.',
    tip: 'Book the Huwon tour online well in advance — it sells out weeks ahead in spring and autumn. The moonlight tour (cgg.cha.go.kr) is one of the best evening experiences in the city.',
...

  {
    id: 56,
    nbhd: 'nbhd-jongno',
    name: 'Samcheong-dong Galleries & Craft Shops 삼청동',
    cat: 'landmark',
    emoji: '🖼️',
    ...
    note: "The street running north from Gyeongbokgung to Bukchon has the highest density of independent art galleries in Seoul — around thirty, mostly in converted hanok and low-rise buildings. The Korea Craft and Design Foundation on Samcheong-ro hosts rotating contemporary craft exhibitions. The Whanki Museum, a short walk up the hill, holds the definitive collection of Korean abstract expressionism. The neighbourhood's craft shops sell celadon, hanji paper goods, and lacquerware at a quality level well above the Insadong tourist stalls.",
    hours: 'Most galleries and shops Tue–Sun 10:00–18:00; closed Mon. Whanki Museum: Tue–Sun 10:00–18:00.',
    tip: 'Walk the full length of Samcheong-ro from Anguk Station toward Bukchon — the gallery concentration is densest in the 300-metre stretch near Bukchon-ro. The Whanki Museum requires a small entrance fee.',
...

  {
    ...
    note: 'A six-kilometre stream running through the centre of Seoul, restored in 2005 after the elevated highway that had buried it for four decades was demolished. The result is a linear park at street level — five to seven metres below the city grid — with walkways on both banks, stepping stones, small waterfalls, and rotating art installations. One of the more consequential urban restoration projects of the 2000s. The first kilometre from Cheonggyecheon Plaza toward Gwangtonggyo Bridge is the most visited; east of Ogansugyo Bridge the crowds thin quickly.',
...

  {
    ...
    note: "Zaha Hadid's largest completed project: 86,000 square metres of aluminium-clad organic form with no straight walls or right angles, opened in 2014 on the site of the old Dongdaemun Stadium. Inside are exhibition halls, a design museum, a design marketplace, and a multipurpose hall used for fashion weeks and digital art installations. The exterior is best at night when the surface is illuminated. The area directly around DDP runs largely 24 hours — the wholesale fashion market in Doosan Tower (두산타워, five minutes' walk) trades from midnight to 5am.",
...

  {
    ...
    note: 'The largest museum in Asia by collection size — 220,000 artefacts across six permanent galleries — and free to enter. The collection covers Korean history from the Palaeolithic through the Joseon dynasty: Three Kingdoms gold crowns, Goryeo celadon regarded as the finest in the world, a 14-metre pagoda in its own atrium, and Joseon-era royal portrait paintings. The building is architecturally considered (Joseon geometric forms in concrete), and the reflecting pool between the entrance and Namsan creates one of the better composed views of the tower in the city.',
    hours: 'Tue–Sun 10:00–18:00; Wed & Sat until 21:00; closed Mon.',
    tip: 'Allow three hours minimum for the permanent collection. The museum café terrace faces Namsan Tower across the reflecting pool — one of the more peaceful lunch stops in the city. Free audio guides at the information desk.',
...

  {
    ...
    note: "Samsung's private art museum, designed by three separate architects: Mario Botta (Korean heritage collection, terracotta drum building), Jean Nouvel (contemporary collection, black stainless steel building), and Rem Koolhaas (education centre). The historic Korean collection holds celadon, bronze, and lacquerware from the Three Kingdoms period through Joseon. The contemporary collection runs from Korean modernism of the 1950s through international works — Lee Ufan, Damien Hirst, Anish Kapoor. One of the strongest private museums in Asia.",
    hours: 'Tue–Sun 10:00–18:00; closed Mon.',
    tip: 'Book tickets online — capacity is limited and weekends sell out. The museum shop has the best art publications and design objects in Seoul.',
...

  {
    id: 61,
    nbhd: 'nbhd-gangnam',
    name: 'Garosu-gil & Apgujeong 가로수길·압구정',
    cat: 'cafe',
    emoji: '🌿',
    address: 'Garosu-gil: near Sinnonhyeon Station (Line 9), Gangnam-gu. Apgujeong: Apgujeong Station (Line 3).',
    lat: 37.5194,
    lng: 127.0198,
    search: 'Garosu-gil 가로수길 Apgujeong Seoul boutique cafe',
    note: "Two adjacent districts that define Seoul's upscale street culture. Garosu-gil is a 700-metre ginkgo-lined boulevard of independent boutiques, Korean beauty flagships, and specialty coffee shops — best in autumn when the trees turn yellow. The more interesting parts have retreated from rising rents into the side alleys (Sero-gil and the lanes behind). Apgujeong, to the east, is the older luxury district: Cheongdam-dong has the international flagship stores (Chanel, Dior, Bottega Veneta) in low-rise buildings designed with more care than most European equivalents. The Hyundai Department Store Apgujeong (1985) has the best basement food hall in the city.",
    hours: 'Most shops 10:30–21:00. Hyundai Department Store: 10:30–20:00.',
    tip: 'Skip the Garosu-gil main strip on weekends. The side alleys have the independent boutiques and quieter cafés that make the area worth visiting. The Cheongdam Circle Walk — a public art path around the luxury retail block — takes 30 minutes.',
...

  {
    ...
    note: "The neighbourhood immediately west of Hongdae, transformed since 2016 into the city's most concentrated strip of independent cafés, natural wine bars, and single-item restaurants — without yet becoming a tourist destination. The Gyeongui Line Forest Park (경의선숲길), a six-kilometre green corridor built along a decommissioned rail line, runs through its centre, and most of the neighbourhood's best spots open onto it. Mostly Koreans in their twenties and thirties; still neighbourhood-paced rather than performance-paced.",
    hours: 'Most cafés 11:00–22:00; bars later. Busiest Thu–Sun evenings.',
    tip: 'Walk west from Hongik University Station exit 3 along the rail path. Go mid-week. The natural wine shops and small cocktail bars on the west end of Yeonnam-ro are the most interesting part, especially after 20:00.',
...

  {
    ...
    note: "Twelve riverside parks stretch along 41 kilometres of the Han River; the Yeouido section is the most used. On summer evenings the grassed banks fill with Seoulites picnicking on delivery orders and convenience store food — a specific piece of local social culture that most visitors miss entirely. Bicycle hire (Ttareungyi public bikes, around ₩1,000 per hour) runs along both banks; the riverside cycling path connects Yeouido to Mapo Bridge and further east without touching a road. The city skyline from the water at dusk is one of the better views Seoul offers.",
    hours: 'Open 24 hours. Bike rental: dawn to dusk.',
    tip: 'Go at dusk on a clear evening. Order Korean fried chicken delivery via Coupang Eats to the park entrance — this is how Seoulites eat on summer nights. The Wonhyo Bridge section is quieter than the main Yeouido grass.',
...

  {
    ...
    note: 'A granite massif rising to 836 metres on the northern edge of Seoul, accessible by metro in 30 minutes. The Baegundae ridge route from Gupabal Station takes three to four hours return and ends on bare granite with an unobstructed panorama of the city. The trail passes Bukhansanseong mountain fortress — an 8th-century stone wall that runs for kilometres along the ridgeline. Over 13 million people hike here annually. The Jingwan Valley trails are substantially quieter than the main Baegundae route.',
    hours: 'Open year-round. Entrance gates close at 16:00 in winter. No facilities on upper sections.',
    tip: 'Go on a weekday. Bring water — there are no vendors above the visitor centre. The descent via Bukhansanseong Fortress (rather than the standard route) adds 30 minutes and is worth it for the fortress wall section.',
...

  {
    id: 65,
    nbhd: 'nbhd-jongno',
    name: 'Gwanghwamun Square & Cheongwadae 광화문광장·청와대',
    cat: 'landmark',
    emoji: '🏛️',
    address: 'Gwanghwamun Square: Sejongno, Jongno-gu (Gwanghwamun Station exit 2). Cheongwadae: 1 Cheongwadae-ro, Jongno-gu.',
    lat: 37.5759,
    lng: 126.9769,
    search: 'Gwanghwamun Square Cheongwadae Blue House Seoul 청와대',
    note: 'Gwanghwamun Square was redesigned in 2022 — doubled in width, traffic removed from both flanks — forming a proper civic forecourt to Gyeongbokgung Palace. The statues of Admiral Yi Sun-sin and King Sejong stand on axis with the palace gate; on clear days the view frames Baegundae peak in Bukhansan directly behind. Cheongwadae (the Blue House), the presidential residence for over 70 years, was opened to the public in May 2022. The grounds include the original residence building, the gardens, and a museum on Korean presidential history. Free entry.',
    hours: 'Gwanghwamun Square: 24 hours. Cheongwadae: Tue–Sun 09:00–18:00, last entry 17:00; closed Mon. Free.',
    tip: 'Cheongwadae is best in spring (cherry blossom along the approach road, late March–early April) and autumn. Allow 90 minutes — the grounds are extensive. The Nokjiwon garden behind the main building is the quietest section.',
