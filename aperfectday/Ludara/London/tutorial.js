(function () {
  ...
  var STEPS = [
    {
      ...
      body: 'One map. 50 places most guests never find. All earned their spot. Tap Next to begin.',
      target: null,
      cardPos: 'center',
      demo: null,
      btn: 'Next'
    },
    {
      ...
      body: 'Every pin is a choice: a wine bar Londoners actually use, a gallery most guests walk past, a bookshop that has traded from the same room for over a century. Tap any icon to see why it made the list.',
      target: null,
      cardPos: 'center',
    ...
    },
    {
      ...
      body: 'Looking for a classic pub or a Michelin-starred dining room? A Royal London landmark? Slide the bar to show only the category you want — the map follows.',
      target: '.filter-bar',
      cardPos: 'center',
      closeCard: true,
      demo: 'scroll-filter',
    ...
    },
    {
      ...
      body: 'Each button is a London neighbourhood. Tap to zoom straight in. London rewards those who drift — let the districts guide you.',
      target: '#nbhd-bar',
      cardPos: 'center',
      closeCard: true,
      demo: null,
    ...
    },
    {
      ...
      body: "London's streets and the Underground can both drop your signal. Tap the circle to find yourself on the map. Save it offline and it works without Wifi too.",
      target: null,
    ...
    },
    {
      ...
      body: 'London is yours to discover. Go find your perfect day.',
      target: null,
      cardPos: 'center',
  ...
  /* ── Auto-start on first visit DISABLED 2026-06-14 (per Maria) ──
     Visitors explore the map first and open the tutorial themselves
