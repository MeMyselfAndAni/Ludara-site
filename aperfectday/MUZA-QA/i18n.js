...
const STRINGS = {
  ...
  ru: {
    ...
    ui: {
      ...
      saved_word:"Сохранённые",
      drag_reorder:"Перетащите ⠿, чтобы изменить порядок",
      itinerary:"🗺 Маршрут",
      auto:"↺ Авто",
      empty_saved:"Нажмите ♡ на любом месте,<br>чтобы сохранить его здесь",
      saved_cleared:"Сохранённые места очищены.",
      on_map:"на карте",
      ...
      no_saved_title:"Пока нет сохранённых мест",
      no_saved_body:"Нажмите ♡ на любом павильоне, чтобы сохранить его здесь, — затем спланируйте маршрут, скачайте PDF или сохраните карту для офлайн-доступа.",
