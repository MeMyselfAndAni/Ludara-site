(function () {
  ...
  var STEPS = [
    ...
    },
    {
      ...
      body: 'Each card has the place name, what is on display now and the current exhibition, plus a visitor tip. Scroll for the website and a walking route to it.',
      target: null,
      cardPos: 'center',
      demo: 'scroll-card',
      btn: 'Next'
  ...
  var TUT_HE = {
    ...
    'Inside the place card': { title:'בתוך כרטיס המקום',
      body:'בכל כרטיס תמצאו את שם המקום, מה מוצג עכשיו והתערוכה הנוכחית, וטיפ למבקר. גללו לאתר וגם למסלול הליכה אליו.' },
  ...
  var TUT_RU = {
    ...
    'Inside the place card': { title:'Внутри карточки места',
      body:'В каждой карточке — название места, что выставлено сейчас и текущая выставка, а также совет для посетителя. Прокрутите вниз до сайта и пешего маршрута.' },
  ...
  var TUT_AR = {
    ...
    'Inside the place card': { title:'داخل بطاقة المكان',
      body:'تضمّ كل بطاقة اسم المكان، وما يُعرض الآن والمعرض الحالي، ونصيحة للزائر. مرِّر للأسفل للوصول إلى الموقع ومسار المشي إليه.' },
