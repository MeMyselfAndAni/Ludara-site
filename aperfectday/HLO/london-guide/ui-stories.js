const NBHD_META = {
  'city':         { label: 'The City',        icon: '🏙️' },
  'south-bank':   { label: 'South Bank',      icon: '🌉' },
  'east-london':  { label: 'East London',     icon: '🎨' },
  'west-end':     { label: 'West End',        icon: '🎭' },
  'north-london': { label: 'North London',    icon: '🎸' },
  'west-london':  { label: 'West London',     icon: '🌸' },
  'greenwich':    { label: 'Greenwich & SE',  icon: '🏛️' },
};
const CL_STORIES = {
  landmark:'Landmark', food:'Restaurant', cafe:'Café & Coffee',
  bar:'Bar & Views', market:'Market', park:'Park & Nature', art:'Art & Culture'
};

// Neighbourhood map bounds for zoom-to
const NBHD_BOUNDS = {
  'city':         { lat:51.5138, lng:-0.0900, zoom:14 },
  'south-bank':   { lat:51.5048, lng:-0.0940, zoom:14 },
  'east-london':  { lat:51.5240, lng:-0.0730, zoom:13 },
  'west-end':     { lat:51.5095, lng:-0.1280, zoom:14 },
  'north-london': { lat:51.5440, lng:-0.1470, zoom:13 },
  'west-london':  { lat:51.5040, lng:-0.1890, zoom:13 },
  'greenwich':    { lat:51.4800, lng:-0.0300, zoom:12 },
};
