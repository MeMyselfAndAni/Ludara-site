...
const CAT_COLORS = {
  attraction:'#B07D3F', dining:'#A23A2E', cafe:'#5F8A5A', bar:'#6A4A78', craft:'#C8862E',
  landmark:'#B07D3F', food:'#A23A2E'
};
const CAT_LABELS = {
  attraction:'Sights & Landmarks', dining:'Dining', cafe:'Cafés', bar:'Bars & Wine', craft:'Craft & Shops',
  landmark:'Sights & Landmarks', food:'Dining'
};
const CAT_GRADIENTS = {
  attraction:'linear-gradient(135deg,#5c4a2a,#9c7a3a)',
  dining:    'linear-gradient(135deg,#5c1a22,#a23a2e)',
  cafe:      'linear-gradient(135deg,#1a3a2a,#3a7a4a)',
  bar:       'linear-gradient(135deg,#3a1a4a,#6a4a8a)',
  craft:     'linear-gradient(135deg,#5c3a1a,#c8862e)',
  landmark:  'linear-gradient(135deg,#5c4a2a,#9c7a3a)',
  food:      'linear-gradient(135deg,#5c1a22,#a23a2e)',
};
...
function _populateCard(p){
  ...
  const staffMatch = p.tip && p.tip.match(/A Hotel Evmolpia pick\s*[—–-]\s*([A-Za-z]+)[.]?\s*([\s\S]*)/i);
