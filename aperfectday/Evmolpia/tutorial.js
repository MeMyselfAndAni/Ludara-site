(function () {
  ...
  var STEPS = [
    {
      ...
      body: 'We curated ' + (typeof PLACES !== 'undefined' ? PLACES.length : 20) + ' places for you to explore and plan your perfect day in ' + CITY + '. Tap Next to start.',
      target: null,
      cardPos: 'center',
      demo: null,
      btn: 'Next'
    ...
    },
    {
      ...
      body: CITY + ' is waiting. Go find your perfect day.',
      target: null,
      cardPos: 'center',
  ...
  style.textContent = [
    ...
    '#tut-nudge{position:fixed;right:12px;bottom:268px;z-index:1200;max-width:236px;',
