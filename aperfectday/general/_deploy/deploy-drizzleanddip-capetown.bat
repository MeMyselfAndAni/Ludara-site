@echo off
REM ============================================================
REM  deploy-drizzleanddip-capetown.bat
REM  Deploys Drizzle & Dip / Cape Town guide (v2 MapLibre)
REM
REM  Run from:  ...\Ludara-site\aperfectday\general\_deploy\
REM  Live at:   https://ludara.ai/aperfectday/drizzleanddip/capetown/
REM ============================================================

set GUIDE=drizzleanddip\capetown
...
cd /d "%REPO_ROOT%"
git add -A
git commit -m "Deploy drizzleanddip/capetown — A Perfect Day guide"
git push

echo.
echo ==========================================================
echo  Done! Live in ~30s at:
echo  https://ludara.ai/aperfectday/drizzleanddip/capetown/
echo ==========================================================
echo.
pause
