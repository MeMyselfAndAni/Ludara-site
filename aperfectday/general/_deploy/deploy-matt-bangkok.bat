@echo off
REM ============================================================
REM  deploy-matt-bangkok.bat
REM  Deploys the Nomadic Matt / Bangkok guide (v2 MapLibre)
REM
REM  Run from:  C:\Users\Maria\OneDrive\Dokumentumok\Ludara\Ludara-site\aperfectday\general\_deploy\
REM  Live at:   https://ludara.ai/aperfectday/nomadicmatt/bangkok/
REM ============================================================

set GUIDE=nomadicmatt\bangkok
...
REM ── Copy all 9 shared platform files into the guide folder ───────────────────
...
echo.
echo Committing...
git commit -m "Deploy %GUIDE% — update platform files and guide content"
...
echo  https://ludara.ai/aperfectday/nomadicmatt/bangkok/
echo ==========================================================
echo.
pause
