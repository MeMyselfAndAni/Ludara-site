@echo off
REM ============================================================
REM  deploy-Ludara-NewOrleans.bat
REM  Deploys Ludara / New Orleans guide (v2 MapLibre)
REM
REM  Run from:  ...\Ludara-site\aperfectday\general\_deploy\
REM  Live at:   https://ludara.ai/aperfectday/Ludara/NewOrleans/
REM ============================================================

set GUIDE=Ludara\NewOrleans
...
cd /d "%REPO_ROOT%"
git add -A
git commit -m "Deploy Ludara/NewOrleans — A Perfect Day demo guide (50 places)"
git push

echo.
echo ==========================================================
echo  Done! Live in ~30s at:
echo  https://ludara.ai/aperfectday/Ludara/NewOrleans/
echo ==========================================================
echo.
pause
