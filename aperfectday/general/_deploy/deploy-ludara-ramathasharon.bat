@echo off
REM ============================================================
REM  deploy-ludara-ramathasharon.bat
REM  Deploys Ludara / Ramat HaSharon guide (v2 MapLibre)
REM
REM  Run from:  ...\Ludara-site\aperfectday\general\_deploy\
REM  Live at:   https://ludara.ai/aperfectday/Ludara/RamatHaSharon/
REM ============================================================

set GUIDE=Ludara\RamatHaSharon
...
cd /d "%REPO_ROOT%"
git add -A
git commit -m "Deploy Ludara/RamatHaSharon — A Perfect Day guide"
git push

echo.
echo ==========================================================
echo  Done! Live in ~30s at:
echo  https://ludara.ai/aperfectday/Ludara/RamatHaSharon/
echo ==========================================================
echo.
pause
