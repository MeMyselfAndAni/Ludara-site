@echo off
REM ============================================================
REM  deploy-zenkimchi-seoul.bat
REM  Deploys ZenKimchi / Seoul guide (v2 MapLibre)
REM
REM  Run from:  ...\Ludara-site\aperfectday\general\_deploy\
REM  Live at:   https://ludara.ai/aperfectday/zenkimchi/seoul/
REM ============================================================

set GUIDE=zenkimchi\seoul
...
cd /d "%REPO_ROOT%"
git add -A
git commit -m "Deploy zenkimchi/seoul — A Perfect Day guide"
git push
