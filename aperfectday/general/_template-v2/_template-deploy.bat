@echo off
REM ============================================================
REM  deploy-BLOGGER-CITY.bat
REM  Deploys [BLOGGER] / [CITY] guide (v2 MapLibre)
REM
REM  Run from:  ...\Ludara-site\aperfectday\general\_deploy\
REM  Live at:   https://ludara.ai/aperfectday/BLOGGER/CITY/
REM ============================================================
...
cd /d "%REPO_ROOT%"
git add -A
git commit -m "Deploy %GUIDE% — A Perfect Day guide"
git push
