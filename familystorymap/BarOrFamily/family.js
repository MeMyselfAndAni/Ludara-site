...
var FAMILY = {
  ...
  cacheVersion: 51,           // bump on every deploy so the service worker updates
  ...
  threads: [
    ...
    { key:'israel',   color:'#f2811a', dark:'#b85f10', tint:'#fef2e6', label:'ישראל, הבית החדש' },
  ...
  regions: [
    ...
    { key:'israel',     color:'#f2811a', minRadius:30000,  center:{ lat:32.50, lng:34.95 },  label:'ישראל' },
