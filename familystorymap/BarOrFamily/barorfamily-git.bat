...
set "FILES=index.html data.js people.js map.js map-core.js ui-card.js ui-filter.js ui-stories.js ui-favourites.js ui-pdf.js ui-tree.js tutorial.js photos.js credits.js styles.css sw.js favicon.svg minimize-images.js"
...
echo.
echo =====================================
echo   BAR-OR FAMILY MAP COMMITTED ^& PUSHED!
echo =====================================
echo.
