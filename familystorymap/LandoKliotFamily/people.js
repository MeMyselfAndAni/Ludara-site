...
const PEOPLE = [
  ...
  { id:'efraim',    he:'אפרים קליוט', ru:'Эфраим Клиот', en:'Efraim Kliot', years:'', role:'"אוקטובר האדום" · «Красный Октябрь» · payroll chief, "Red October"', branch:'kliot', col:3.0, row:2, places:[5,7,35] },
  { id:'rita_e',    he:'ריטה קליוט', ru:'Рита Клиот', en:'Rita Kliot', years:'', role:'רעיית אפרים, חיה בוולגוגרד · жена Эфраима, жила в Волгограде · Efraim\'s wife, lived in Volgograd', branch:'kliot', col:4.0, row:2, places:[35] },
  ...
  { id:'semyon',    he:'סמיון קליוט', ru:'Семён Клиот', en:'Semyon Kliot', years:'נפ׳ ~2015 · ум. ~2015 · d. ~2015', role:'בן אפרים וריטה, חי בוולגוגרד · сын Эфраима и Риты, жил в Волгограде · son of Efraim and Rita, lived in Volgograd', branch:'kliot', col:2.9, row:3, places:[35] },
  { id:'olga_e',    he:'אולגה קליוט', ru:'Ольга Клиот', en:'Olga Kliot', years:'', role:'בת אפרים וריטה; חיה בוולגוגרד · дочь Эфраима и Риты, живёт в Волгограде · daughter of Efraim and Rita, lives in Volgograd', branch:'kliot', col:4.0, row:3, places:[35] },
  ...
  { id:'anna',      he:'אנה קליאוט־לנדו', ru:'Анна', en:'Anna Kliot-Lando', years:'נ׳ 1948', role:'המחברת · автор воспоминаний · author of the memoirs', branch:'kliot', col:11.3, row:3, places:[10,7,33,20,22,23] },
  ...
  { id:'natasha',   he:'נטשה גורביץ׳', ru:'Наташа Гуревич', en:'Natasha Gurevich', years:'', role:'אם מארק וניקול · мать Марка и Николь · mother of Mark and Nikol', branch:'lando', col:10.6, row:4, places:[20] },
  ...
  { id:'milia',     he:'מיליה זייצבה (שכטר)', ru:'Миля Зайцева (Шехтер)', en:'Milia Zaitzeva (Schechter)', years:'', role:'אחותה של חומה, דודתו של מישה · сестра Хумы, тётя Миши · Huma\'s sister, Misha\'s aunt', branch:'lando', col:21.6, row:2, places:[7] },
  { id:'huma',      he:'חומה (חנה) שכטר', ru:'Хума (Хана) Шехтер', en:'Huma (Hana) Schechter', years:'1900–1985', role:'אם מישה · мать Миши · Misha\'s mother', branch:'lando', col:23.6, row:2, places:[8,7,13] },
  { id:'gersh_s',   he:'גרש שכטר', ru:'Герш Шехтер', en:'Gersh Schechter', years:'1903–1960', role:'אחיה הצעיר של חומה, קבור במוסקבה · младший брат Хумы, похоронен в Москве · Huma\'s younger brother, buried in Moscow', branch:'lando', col:22.6, row:2, places:[7] },
  ...
  { id:'lyonya',    he:'ליוניה (לאוניד) זייצב', ru:'Лёня (Леонид) Зайцев', en:'Lyonya (Leonid) Zaitzev', years:'', role:'בנה של מיליה, נשאר במוסקבה · сын Мили, остался в Москве · Milia\'s son, stayed in Moscow', branch:'lando', col:20.8, row:3, places:[7] },
  { id:'marina',    he:'מרינה זייצבה', ru:'Марина Зайцева', en:'Marina Zaitzeva', years:'', role:'בתה של מיליה · дочь Мили · Milia\'s daughter', branch:'lando', col:21.8, row:3, places:[7] },
  { id:'volodya',   he:'וולודיה פיינשטיין', ru:'Володя Файнштейн', en:'Volodya Fainshtein', years:'', role:'בעלה של מרינה · муж Марины · Marina\'s husband', branch:'lando', col:22.8, row:3, places:[7] },
  ...
  { id:'yefim',     he:'יפים', ru:'Ефим', en:'Yefim', years:'נפל ~1942', role:'כירורג, נפל בסטלינגרד · хирург, погиб · surgeon, fell at Stalingrad', branch:'lando', col:28.2, row:3, places:[8,14,30,31] },
  { id:'pavel',     he:'פאבל', ru:'Павел', en:'Pavel', years:'', role:'רופא בצ׳יטה · врач в Чите · doctor in Chita', branch:'lando', col:29.2, row:3, places:[8,19,30] },
  { id:'vera',      he:'ורה', ru:'Вера', en:'Vera', years:'', role:'נשארה באודסה · осталась в Одессе · stayed in Odessa', branch:'lando', col:30.2, row:3, places:[8,30] },
];
