...
const PEOPLE = [
  ...
  { id:'david_s',   he:'דויד שכטר', ru:'Давид Шехтер', en:'David Schechter', years:'', role:'סבא של מישה · дед Миши · Misha\'s grandfather', branch:'schechter', col:23.6, row:1, places:[8] },
  { id:'odiya',     he:'ליה שכטר', ru:'Лия Шехтер', en:'Lia Schechter', years:'', role:'סבתא של מישה · бабушка Миши · Misha\'s grandmother', branch:'schechter', col:24.6, row:1, places:[8] },
  ...
  { id:'sara_s',    he:'שרה שכטר', ru:'Сара Шехтер', en:'Sara Schechter', years:'', role:'אחותה הצעירה של חומה · младшая сестра Хумы · Huma\'s youngest sister', branch:'schechter', col:20.6, row:2, places:[] },
  { id:'milia',     he:'מיליה שכטר', ru:'Миля Шехтер', en:'Milia Schechter', years:'', role:'אחותה של חומה, דודתו של מישה · сестра Хумы, тётя Миши · Huma\'s sister, Misha\'s aunt', branch:'schechter', col:21.6, row:2, places:[7] },
  { id:'huma',      he:'חומה (חנה) שכטר', ru:'Хума (Хана) Шехтер', en:'Huma (Hana) Schechter', years:'1900–1985', role:'אם מישה · мать Миши · Misha\'s mother', branch:'schechter', col:23.6, row:2, places:[8,7,13] },
  { id:'gersh_s',   he:'גרש (גרישה) שכטר', ru:'Герш (Гриша) Шехтер', en:'Gersh (Grisha) Schechter', years:'1903–1960', role:'אחיה הצעיר של חומה, קבור במוסקבה · младший брат Хумы, похоронен в Москве · Huma\'s younger brother, buried in Moscow', branch:'schechter', col:22.6, row:2, places:[7] },
  ...
  { id:'husband1',  he:'הבעל הראשון', ru:'первый муж', en:'the first husband', years:'', role:'שידוך בכפייה · брак по сговору · an arranged match', branch:'lando', col:28.7, row:2, places:[8,30] },
  { id:'roza',      he:'רוזה', ru:'Роза', en:'Roza', years:'', role:'אחות ברוך · сестра Баруха · Boruch\'s sister', branch:'lando', col:29.7, row:2, places:[8,30] },
  { id:'shaul',     he:'שאול (שולה)', ru:'Шауль (Шуля)', en:'Shaul (Shula)', years:'', role:'אהובה של רוזה, כלכלן · любимый муж, экономист · Roza\'s beloved husband, an economist', branch:'lando', col:30.7, row:2, places:[8,9,30] },
  { id:'hana_dau',  he:'בתה של חנה', ru:'дочь Ханы', en:'Hana\'s daughter', years:'', role:'נישאה בקישינב · вышла замуж в Кишинёве · married in Kishinev', branch:'lando', col:27, row:3, places:[] },
  { id:'lilya',     he:'ליליה קולקר', ru:'Лиля Колкер', en:'Lilya Kolker', years:'', role:'עלתה לישראל · репатриировалась в Израиль · emigrated to Israel', branch:'lando', col:26, row:4, places:[] },
  { id:'volodya_k', he:'וולודיה קולקר', ru:'Володя Колкер', en:'Volodya Kolker', years:'', role:'בעלה של ליליה · муж Лили · Lilya\'s husband', branch:'lando', col:27, row:4, places:[] },
  { id:'faya',      he:'פאיה מרטינובסקיה', ru:'Фая Мартиновская', en:'Faya Martinovskaya', years:'', role:'עלתה לישראל · репатриировалась в Израиль · emigrated to Israel', branch:'lando', col:28, row:4, places:[] },
  { id:'senya',     he:'סניה מרטינובסקי', ru:'Сеня Мартиновский', en:'Senya Martinovsky', years:'', role:'בעלה של פאיה · муж Фаи · Faya\'s husband', branch:'lando', col:29, row:4, places:[] },
  { id:'evgeny_k',  he:'יבגני קולקר', ru:'Евгений Колкер', en:'Evgeny Kolker', years:'', role:'בנם של ליליה וולודיה, חי בניו יורק · сын Лили и Володи, живёт в Нью-Йорке · Lilya and Volodya\'s son, lives in New York', branch:'lando', col:26.5, row:5, places:[] },
  { id:'evg_dau',   he:'בתו של יבגני', ru:'дочь Евгения', en:'Evgeny\'s daughter', years:'', role:'נכדתם של ליליה וולודיה · внучка Лили и Володи · Lilya and Volodya\'s granddaughter', branch:'lando', col:26, row:6, places:[] },
  { id:'benjamin_k',he:'בנימין קולקר', ru:'Вениамин Колкер', en:'Benjamin Kolker', years:'', role:'בנו של יבגני · сын Евгения · Evgeny\'s son', branch:'lando', col:27, row:6, places:[] },
  { id:'boris_m',   he:'בוריס מרטינובסקי', ru:'Борис Мартиновский', en:'Boris Martinovsky', years:'', role:'בנם של פאיה וסניה · сын Фаи и Сени · son of Faya and Senya', branch:'lando', col:28.5, row:5, places:[] },
  { id:'mark_s',    he:'מארק רבינוביץ׳', ru:'Марк Рабинович', en:'Mark Rabinovich', years:'', role:'בנה של שרה, חי במעלה אדומים · сын Сары, живёт в Маале-Адумим · Sara\'s son, lives in Maale Adumim', branch:'schechter', col:19.6, row:3, places:[] },
  { id:'bella_s',   he:'בלה רבינוביץ׳', ru:'Белла Рабинович', en:'Bella Rabinovich', years:'', role:'אשתו של מארק · жена Марка · Mark\'s wife', branch:'schechter', col:20.6, row:3, places:[] },
  { id:'inna_r',    he:'אינה רבינוביץ׳', ru:'Инна Рабинович', en:'Inna Rabinovich', years:'', role:'בתם של מארק ובלה · дочь Марка и Беллы · daughter of Mark and Bella', branch:'schechter', col:19.7, row:4, places:[] },
  { id:'anna_r',    he:'אנה רבינוביץ׳', ru:'Анна Рабинович', en:'Anna Rabinovich', years:'', role:'בתם של מארק ובלה · дочь Марка и Беллы · daughter of Mark and Bella', branch:'schechter', col:20.7, row:4, places:[] },
  { id:'alla',      he:'אלה', ru:'Алла', en:'Alla', years:'', role:'בתה של מיליה, אם מרינה ולאוניד · дочь Мили, мать Марины и Леонида · Milia\'s daughter, mother of Marina and Leonid', branch:'schechter', col:21.6, row:3, places:[7] },
  { id:'lyonya',    he:'ליוניה (לאוניד) זייצב', ru:'Лёня (Леонид) Зайцев', en:'Lyonya (Leonid) Zaitzev', years:'', role:'בנה של אלה, חי במוסקבה · сын Аллы, живёт в Москве · Alla\'s son, lives in Moscow', branch:'schechter', col:21.7, row:4, places:[7] },
  { id:'marina',    he:'מרינה זייצבה', ru:'Марина Зайцева', en:'Marina Zaitzeva', years:'', role:'בתה של אלה, חיה בלונדון · дочь Аллы, живёт в Лондоне · Alla\'s daughter, lives in London', branch:'schechter', col:22.7, row:4, places:[7] },
  { id:'volodya',   he:'וולודיה פיינשטיין', ru:'Володя Файнштейн', en:'Volodya Fainshtein', years:'', role:'ולדימיר, בעלה של מרינה · Владимир, муж Марины · Vladimir, Marina\'s husband', branch:'schechter', col:23.7, row:4, places:[7] },
  { id:'anya_v',    he:'אניה פיינשטיין', ru:'Аня Файнштейн', en:'Anya Fainshtein', years:'', role:'בתם של מרינה וולודיה · дочь Марины и Володи · daughter of Marina and Volodya', branch:'schechter', col:22.2, row:5, places:[] },
  { id:'masha_v',   he:'מאשה פיינשטיין', ru:'Маша Файнштейн', en:'Masha Fainshtein', years:'', role:'בתם של מרינה וולודיה · дочь Марины и Володи · daughter of Marina and Volodya', branch:'schechter', col:23.2, row:5, places:[] },
  ...
  { id:'misha_r',   he:'מישה (מיכאל)', ru:'Миша (Михаил)', en:'Misha (Michael)', years:'', role:'בן רוזה; היגר לארה״ב · сын Розы, США · Roza\'s son; emigrated to the USA', branch:'lando', col:28.7, row:3, places:[8,14,30] },
  { id:'yefim',     he:'יפים', ru:'Ефим', en:'Yefim', years:'נפל ~1942', role:'כירורג, נפל בסטלינגרד · хирург, погиб · surgeon, fell at Stalingrad', branch:'lando', col:29.7, row:3, places:[8,14,30,31] },
  { id:'pavel',     he:'פאבל', ru:'Павел', en:'Pavel', years:'', role:'רופא בצ׳יטה · врач в Чите · doctor in Chita', branch:'lando', col:30.7, row:3, places:[8,19,30] },
  { id:'vera',      he:'ורה', ru:'Вера', en:'Vera', years:'', role:'נשארה באודסה · осталась в Одессе · stayed in Odessa', branch:'lando', col:31.7, row:3, places:[8,30] },
];
...
const FAMILY_UNIONS = [
  ...
  { p:['sara_s'],            c:['mark_s'] },
  { p:['mark_s','bella_s'],  c:['inna_r','anna_r'] },
  { p:['hersh'],             c:['boruch','hana_l','roza'] },
  { p:['boruch','huma'],     c:['mark_l','misha_l','yakov'] },
  { p:['hana_l'],            c:['hana_dau'] },
  { p:['hana_dau'],          c:['lilya','faya'] },
  { p:['lilya','volodya_k'], c:['evgeny_k'] },
  { p:['evgeny_k'],          c:['evg_dau','benjamin_k'] },
  { p:['faya','senya'],      c:['boris_m'] },
  { p:['roza','husband1'],   c:['misha_r','yefim'] },
  { p:['roza','shaul'],      c:['pavel','vera'] },
  { p:['milia'],             c:['alla'] },
  { p:['alla'],              c:['marina','lyonya'] },
  { p:['marina','volodya'],  c:['anya_v','masha_v'] },
  // The meeting point
