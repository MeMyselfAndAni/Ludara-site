...
const PEOPLE = [
  ...
  { id:'sara_s',    he:'שרה שכטר', ru:'Сара Шехтер', en:'Sara Schechter', years:'', role:'אחותה הצעירה של חומה · младшая сестра Хумы · Huma\'s youngest sister', branch:'lando', col:20.6, row:2, places:[] },
  { id:'milia',     he:'מיליה שכטר', ru:'Миля Шехтер', en:'Milia Schechter', years:'', role:'אחותה של חומה, דודתו של מישה · сестра Хумы, тётя Миши · Huma\'s sister, Misha\'s aunt', branch:'lando', col:21.6, row:2, places:[7] },
  ...
  { id:'gersh_s',   he:'גרש (גרישה) שכטר', ru:'Герш (Гриша) Шехтер', en:'Gersh (Grisha) Schechter', years:'1903–1960', role:'אחיה הצעיר של חומה, קבור במוסקבה · младший брат Хумы, похоронен в Москве · Huma\'s younger brother, buried in Moscow', branch:'lando', col:22.6, row:2, places:[7] },
  ...
  { id:'mark_s',    he:'מארק', ru:'Марк', en:'Mark', years:'', role:'בנה של שרה, חי במעלה אדומים · сын Сары, живёт в Маале-Адумим · Sara\'s son, lives in Maale Adumim', branch:'lando', col:19.6, row:3, places:[] },
  { id:'bella_s',   he:'בלה', ru:'Белла', en:'Bella', years:'', role:'אשתו של מארק, שתי בנות · жена Марка, две дочери · Mark\'s wife, two daughters', branch:'lando', col:20.6, row:3, places:[] },
  { id:'alla',      he:'אלה', ru:'Алла', en:'Alla', years:'', role:'בתה של מיליה, אם מרינה ולאוניד · дочь Мили, мать Марины и Леонида · Milia\'s daughter, mother of Marina and Leonid', branch:'lando', col:21.6, row:3, places:[7] },
  { id:'lyonya',    he:'ליוניה (לאוניד) זייצב', ru:'Лёня (Леонид) Зайцев', en:'Lyonya (Leonid) Zaitzev', years:'', role:'בנה של אלה, חי במוסקבה · сын Аллы, живёт в Москве · Alla\'s son, lives in Moscow', branch:'lando', col:20.6, row:4, places:[7] },
  { id:'marina',    he:'מרינה זייצבה', ru:'Марина Зайцева', en:'Marina Zaitzeva', years:'', role:'בתה של אלה, חיה בלונדון · дочь Аллы, живёт в Лондоне · Alla\'s daughter, lives in London', branch:'lando', col:21.6, row:4, places:[7] },
  { id:'volodya',   he:'וולודיה פיינשטיין', ru:'Володя Файнштейн', en:'Volodya Fainshtein', years:'', role:'ולדימיר, בעלה של מרינה · Владимир, муж Марины · Vladimir, Marina\'s husband', branch:'lando', col:22.6, row:4, places:[7] },
  { id:'anya_v',    he:'אניה פיינשטיין', ru:'Аня Файнштейн', en:'Anya Fainshtein', years:'', role:'בתם של מרינה וולודיה · дочь Марины и Володи · daughter of Marina and Volodya', branch:'lando', col:21.1, row:5, places:[] },
  { id:'masha_v',   he:'מאשה פיינשטיין', ru:'Маша Файнштейн', en:'Masha Fainshtein', years:'', role:'בתם של מרינה וולודיה · дочь Марины и Володи · daughter of Marina and Volodya', branch:'lando', col:22.1, row:5, places:[] },
