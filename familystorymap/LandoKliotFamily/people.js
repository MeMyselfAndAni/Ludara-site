...
const PEOPLE = [
  ...
  { id:'kolker_son',he:'בנם של ליליה וולודיה', ru:'сын Лили и Володи', en:'Lilya and Volodya\'s son', years:'', role:'חי בניו יורק · живёт в Нью-Йорке · lives in New York', branch:'lando', col:26.5, row:5, places:[] },
  ...
  { id:'mark_s',    he:'מארק', ru:'Марк', en:'Mark', years:'', role:'בנה של שרה, חי במעלה אדומים · сын Сары, живёт в Маале-Адумим · Sara\'s son, lives in Maale Adumim', branch:'schechter', col:19.6, row:3, places:[] },
  { id:'bella_s',   he:'בלה', ru:'Белла', en:'Bella', years:'', role:'אשתו של מארק, שתי בנות · жена Марка, две дочери · Mark\'s wife, two daughters', branch:'schechter', col:20.6, row:3, places:[] },
  ...
  { id:'lyonya',    he:'ליוניה (לאוניד) זייצב', ru:'Лёня (Леонид) Зайцев', en:'Lyonya (Leonid) Zaitzev', years:'', role:'בנה של אלה, חי במוסקבה · сын Аллы, живёт в Москве · Alla\'s son, lives in Moscow', branch:'schechter', col:20.6, row:4, places:[7] },
  { id:'marina',    he:'מרינה זייצבה', ru:'Марина Зайцева', en:'Marina Zaitzeva', years:'', role:'בתה של אלה, חיה בלונדון · дочь Аллы, живёт в Лондоне · Alla\'s daughter, lives in London', branch:'schechter', col:21.6, row:4, places:[7] },
  { id:'volodya',   he:'וולודיה פיינשטיין', ru:'Володя Файнштейн', en:'Volodya Fainshtein', years:'', role:'ולדימיר, בעלה של מרינה · Владимир, муж Марины · Vladimir, Marina\'s husband', branch:'schechter', col:22.6, row:4, places:[7] },
  { id:'anya_v',    he:'אניה פיינשטיין', ru:'Аня Файнштейн', en:'Anya Fainshtein', years:'', role:'בתם של מרינה וולודיה · дочь Марины и Володи · daughter of Marina and Volodya', branch:'schechter', col:21.1, row:5, places:[] },
  { id:'masha_v',   he:'מאשה פיינשטיין', ru:'Маша Файнштейн', en:'Masha Fainshtein', years:'', role:'בתם של מרינה וולודיה · дочь Марины и Володи · daughter of Marina and Volodya', branch:'schechter', col:22.1, row:5, places:[] },
...
const FAMILY_UNIONS = [
  ...
  { p:['lilya','volodya_k'], c:['kolker_son'] },
