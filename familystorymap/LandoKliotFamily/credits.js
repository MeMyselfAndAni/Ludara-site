...
const PHOTO_CREDITS = {
  ...
  35: { author: FAMILY_ARCHIVE,
        prefix: 'עומדים: סוניה קליוט, אפרים, מיכאל קליוט ואשתו. יושבים: אשתו של אפרים, הסבא בנימין קליוט, איליה, והסבתא נינה'
              + ' · Стоят: Соня Клиот, Эфраим, Михаил Клиот и его жена. Сидят: жена Эфраима, дедушка Вениамин Клиот, Илья и бабушка Нина'
              + ' · Standing: Sonya Kliot, Efraim, Michael Kliot and his wife. Seated: Efraim\'s wife, grandfather Benjamin Kliot, Ilya, and grandmother Nina' },
