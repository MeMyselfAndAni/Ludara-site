...
const CAT_COLORS = {
  // Bridgerton in Bath categories (match CC in map.js)
  ton:'#d4a043', home:'#c04a2a', street:'#3a8ab0',
...
const CAT_GRADIENTS = {
  // Bridgerton in Bath categories
  ton:     'linear-gradient(135deg,#5c4a1a,#d4a043)',
  home:    'linear-gradient(135deg,#5c2a1a,#c04a2a)',
  street:  'linear-gradient(135deg,#1a3a4c,#3a8ab0)',
