...
<head>
<meta charset="UTF-8">
<title>Bridgerton in Bath · A Perfect Story Map</title>
...
<div class="pdf-cover">
  ...
  <div class="pdf-cover-title">Bridgerton in Bath</div>
  <div class="pdf-cover-subtitle">${window._pdfCoverSubtitle || "Your filming-locations guide: the Bridgerton places of Bath, in your order"}</div>
  ...
  <div class="pdf-cover-stats">
    ...
    <div class="pdf-stat">
      ...
      <div class="pdf-stat-label">Bridgerton filming locations in Bath</div>
    </div>
  </div>
