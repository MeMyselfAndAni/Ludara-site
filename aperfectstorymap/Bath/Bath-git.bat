...
echo   (A Perfect Story Map - Bridgerton in Bath)
echo ================================

set "WORKING=C:\Users\Maria\OneDrive\Dokumentumok\Claude\Projects\A Perfect Day\aperfectstorymap\Bath"
set "DEPLOY=C:\Users\Maria\OneDrive\Dokumentumok\Ludara\Ludara-site\aperfectstorymap\Bath"
rem  Expected live URL after push:  https://ludara.ai/aperfectstorymap/Bath/
...
if "%commit_msg%"=="" set "commit_msg=Bath: update Bridgerton story map demo"
...
echo   https://ludara.ai/aperfectstorymap/Bath/
echo.
