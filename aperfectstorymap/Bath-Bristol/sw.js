...
var SHELL_CACHE = 'apsm-bathbristol-shell-v1';   // bump this on every deploy to push updates
var TILE_CACHE  = 'apsm-bathbristol-tiles-v1';
    ...
    caches.keys().then(function(keys) {
      return Promise.all(
        keys.filter(function(k) {
          return k.startsWith('apsm-bathbristol-shell-') && k !== SHELL_CACHE;
