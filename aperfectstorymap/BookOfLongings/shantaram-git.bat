...
set "WORKING=C:\Users\Maria\OneDrive\Dokumentumok\Claude\Projects\A Perfect Day\aperfectstorymap\Shantaram"
set "DEPLOY=C:\Users\Maria\OneDrive\Dokumentumok\Ludara\Ludara-site\aperfectstorymap\Shantaram"
...
echo.
echo Staging changes in the Shantaram folder...
git add .
