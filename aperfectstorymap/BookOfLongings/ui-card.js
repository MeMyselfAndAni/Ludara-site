...
const CAT_COLORS = {
  // The Book of Longings story threads (match CC in map.js)
  home:'#6b8e4e', voice:'#c9a227', exile:'#2f8f8f', ministry:'#3a6ea5', passion:'#a4402f',
  landmark:'#e8724a', food:'#f0c060', cafe:'#6b9e6e',
  church:'#6090c8', market:'#c08060', soviet:'#9080a8', pub:'#9080a8', nature:'#50906a'
};
const CAT_LABELS = {
  // The Book of Longings story threads (match CL in map.js)
  home:"Ana's Galilee", voice:'Her Book of Longings', exile:'Exile in Alexandria', ministry:'Jesus & the Ministry', passion:'Passover & the Passion',
...
const CAT_GRADIENTS = {
  // The Book of Longings story threads
  home:    'linear-gradient(135deg,#2f3a1e,#6b8e4e)',
  voice:   'linear-gradient(135deg,#5c4a12,#c9a227)',
  exile:   'linear-gradient(135deg,#123a3a,#2f8f8f)',
  ministry:'linear-gradient(135deg,#12314c,#3a6ea5)',
  passion: 'linear-gradient(135deg,#4a160e,#a4402f)',
