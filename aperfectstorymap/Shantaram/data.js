...
const PLACES = [
...

  {
    ...
    visit: 'The bluestone precinct is open to visitors, with guided tours of the old divisions, among them, fittingly, a Shantaram tour.',
...

  {
    ...
    cat: 'journey',
    emoji: '🌾',
    address: 'Rural Maharashtra (a fictional village: the position is symbolic)',
...

  {
    ...
    cat: 'journey',
    emoji: '🏔️',
    address: 'Kandahar Province, Afghanistan (approximate; not a destination)',
