...
echo =====================================
echo   IN ANA'S FOOTSTEPS GIT COMMIT ^& DEPLOY
echo   (A Perfect Story Map)
echo =====================================

set "WORKING=C:\Users\Maria\OneDrive\Dokumentumok\Claude\Projects\A Perfect Day\aperfectstorymap\InAnasFootsteps"
set "DEPLOY=C:\Users\Maria\OneDrive\Dokumentumok\Ludara\Ludara-site\aperfectstorymap\inanasfootsteps"
rem  Expected live URL after push:  https://ludara.ai/aperfectstorymap/inanasfootsteps/
rem  PUBLIC READER EDITION: indexable, linked from holylandwithmaria.com.
...
echo.
echo Staging changes in the inanasfootsteps folder...
git add .
...
if "%commit_msg%"=="" set "commit_msg=In Ana's Footsteps: update reader story map"
...
echo.
echo =====================================
echo   IN ANA'S FOOTSTEPS COMMITTED ^& PUSHED!
echo =====================================
echo.
echo Test online in a minute or two at:
echo   https://ludara.ai/aperfectstorymap/inanasfootsteps/
echo.
echo This is the PUBLIC reader edition - share this URL everywhere.
echo.
pause
endlocal
